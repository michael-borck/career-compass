      ...
      <div className='container mx-auto p-8 max-w-4xl'>
        <div className='space-y-12'>
          ...
          <div className='text-center'>
            ...
            <h1 className='text-[var(--text-3xl)] font-semibold text-ink mb-4'>
          ...
          <div className='bg-accent-soft border border-accent/20 rounded-lg p-8'>
            ...
            <p className='text-ink-muted text-[var(--text-lg)] leading-relaxed'>
              Career Compass empowers individuals to explore career paths that align with their
              skills and interests, all while maintaining complete privacy and data ownership. Your
          ...
          <div>
            ...
            <h2 className='text-[var(--text-2xl)] font-semibold text-ink mb-6'>
              What Career Compass does
            </h2>
            <div className='grid md:grid-cols-2 gap-6'>
              <div className='border border-border rounded-lg p-6 hover:border-ink-muted transition-colors duration-[250ms]'>
                ...
                <p className='text-ink-muted leading-relaxed'>
                  All file processing happens locally on your device. Your resume and personal data
                  never touch our servers.
                </p>
              </div>
              <div className='border border-border rounded-lg p-6 hover:border-ink-muted transition-colors duration-[250ms]'>
                <Bot className='w-6 h-6 text-accent mb-3' />
                <h3 className='font-semibold text-[var(--text-lg)] mb-2 text-ink'>
          ...
          <div className='border-l-2 border-accent p-6 bg-paper'>
            <h2 className='text-[var(--text-2xl)] font-semibold text-ink mb-4'>
              Privacy commitment
            </h2>
            <div className='space-y-3 text-ink-muted'>
              <p className='flex items-start'>
                ...
                <span>
                  No data collection. Your files are processed entirely on your device. The only
                  outbound traffic is to your configured AI provider and, if enabled, your
                  configured search engine. Search queries are derived from your inputs, never the
                  full text.
                </span>
              </p>
              <p className='flex items-start'>
          ...
          <div className='bg-paper-warm rounded-lg p-8'>
            <h2 className='text-[var(--text-2xl)] font-semibold text-ink mb-6 text-center'>
              Get in touch
            </h2>
          ...
          <div className='bg-paper-warm rounded-lg p-6'>
            <h2 className='text-[var(--text-xl)] font-semibold text-ink mb-4 text-center'>
              Acknowledgements
            </h2>
