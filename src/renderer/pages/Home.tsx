...
const SECTIONS: { label: string; cards: CardDef[] }[] = [
  {
    label: 'Discover',
    cards: [
      { title: 'Find my careers', description: 'Generate 6 personalised career paths.', path: '/careers', ported: true },
  ...
  },
  {
    ...
    cards: [
      ...
      { title: 'Learning path', description: 'Step-by-step plan to get job-ready.', path: '/learning-path', ported: true },
      { title: 'Map my skills', description: 'Translate skills into professional frameworks.', path: '/skills-mapping', ported: true },
      { title: 'Practice interview', description: 'Simulate a job interview with feedback.', path: '/interview', ported: true },
    ],
  },
  {
    label: 'Reflect',
  ...
  },
  {
    ...
    cards: [
      ...
      { title: 'Cover letter', description: 'Draft a professional letter for applications.', path: '/cover-letter', ported: true },
      { title: 'Resume review', description: 'Get structured feedback on your resume.', path: '/resume-review', ported: true },
      { title: 'Portfolio page', description: 'Generate a personal portfolio website.', path: '/portfolio', ported: true },
    ],
  },
];
...
const OTHER: CardDef[] = [
  ...
  { title: 'About', description: 'Privacy notes and project background.', path: '/about', ported: true },
];
