...
// 2. Builds the screenshot carousel by probing screenshots/career-compass-1.png,
...
const REPO = 'michael-borck/career-compass'
...
/**
 * Pick the installer for a platform. Asset names come from
 * electron-builder.config.js: Career-Compass-{version}-{arch}.dmg,
 * Career-Compass-Setup-{version}.exe, Career-Compass-{version}-x64.AppImage.
...
const SHOT_PREFIX = 'screenshots/career-compass-'
...
function buildCarousel(urls) {
  ...
  urls.forEach((url, i) => {
    ...
    img.src = url
    img.alt = `Career Compass screenshot ${i + 1}`
