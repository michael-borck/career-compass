...
export default function PitchInputCard() {
  ...
  async function handleRun() {
    ...
    try {
      ...
      const { pitch, trimmed } = (await res.json()) as {
        pitch: ElevatorPitch;
        trimmed?: boolean;
      };
      store.setElevatorPitch(pitch);
      ...
      <div className='border border-border rounded-lg bg-paper p-6'>
        ...
        <div className='space-y-4'>
          ...
          <div className='flex justify-center pt-2'>
            <Button onClick={handleRun} disabled={!hasAny || running}>
              {running ? (
