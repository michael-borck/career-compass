...
exports.default = async function notarizing(context) {
  ...
  // offline (and during Apple-server outages). @electron/notarize only
  // submits and polls — it does NOT staple. Stapling failures are logged
  // but do not fail the build: the app is still validly notarised, the
  // ticket is just fetched online instead of embedded.
  try {
